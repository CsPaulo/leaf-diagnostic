...
# interpretar e exibir as previsões com interpretação usando Lime
...
uploaded_images = st.sidebar.file_uploader("Escolha até 10 imagens", type=['jpg', 'jpeg'], accept_multiple_files=True, key="upload_images")
...
if uploaded_images:
    ...
    for img, features in images_and_features:
        ...
        st.markdown(f"<h4 style='text-align: center; color: black;'>{prediction}</h4>", unsafe_allow_html=True)
